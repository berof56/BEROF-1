...
local json_file, res = https.request("https://raw.githubusercontent.com/berof56/novpi/master/plugins_/games.lua"..file)
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/berof56/novpi/master/plugins_/ZKHRF.lua"..file)
if res == 200 then
